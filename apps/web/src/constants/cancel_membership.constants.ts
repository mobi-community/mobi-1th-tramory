...
export const cancelMembersipConfig: CancelMembersipConfig[] = [
  ...
  },
  {
    title: '미리 백업하기',
    description:
      '등록한 서비스에서 정보 백업을 원하실 경우, 탈퇴 이전에 해당 서비스에서 백업을 진행해주세요. 탈퇴 후에는<br/>데이터를 복구할 수 없습니다.',
  },
  {
    title: '미리 관리하기',
    description:
      '서비스 이용 중 본인의 계정에 귀속되지 않은 정보는 자동으로 삭제되지 않으며, 탈퇴 시 수정이나 삭제가 불가능<br/>합니다. 본인 계정에 귀속되지 않은 정보를 수정하거나 삭제하려는 경우, 회원탈퇴 이전에 해당 서비스에서 수정<br/>또는 삭제를 진행해주세요',
  },
  {
    title: '탈퇴하려는 계정',
    user: userInfo,
