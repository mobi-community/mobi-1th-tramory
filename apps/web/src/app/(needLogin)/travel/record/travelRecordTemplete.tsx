...
const COMPONENTS_MAP = {
  '2': <Step2When config={travelRecordStep2config} />,
  '3': <Step3What config={travelRecordStep3config} />,
  '4': <Step4How config={travelRecordStep4config} />,
  '5': <Step5Sumup config={travelRecordStep5config} />,
};
